...
SETTING_ITEMS = [
    ...
    {"key": "collect.dingtalk_enabled", "label": "启用钉钉采集", "type": "bool",
     "description": "是否读取钉钉会话列表（需钉钉已登录打开）"},
    {"key": "collect.feishu_enabled", "label": "启用飞书采集", "type": "bool",
     "description": "是否读取飞书会话列表（需飞书已登录打开）"},
    {"key": "collect.onenote_enabled", "label": "启用OneNote采集", "type": "bool",
     "description": "是否读取 OneNote 最近页面（需 OneNote 已打开）"},
